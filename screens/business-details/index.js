...
const BusinessDetails = () => {
  ...
  return <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.skillsContainer}>
          <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
            {skills.map((skill, index) => <View key={index} style={styles.skillBox}>
                <Text>{skill}</Text>
              </View>)}
          </ScrollView>
        </View>
      ...
      <Footer titles={["Home", "Task", "Availability", "Account", "My Business"]} images={[require("./assets/homeIcon.png"), require("./assets/listIcon.png"), require("./assets/availabilityIcon.png"), require("./assets/accountIcon.png"), require("./assets/businessIconActive.png")]} active={4} />
    </View>;
};

...
const JobDetailsProviderViewScreen = () => {
  return <ScrollView>
      <View style={styles.container}>
        ...
        <View style={[styles.chooseContainer, styles.piTWRzOe]}>
          <Text>8</Text>
        </View>
        ...
        <View style={styles.sliderTextContainer}>
          ...
          <Text style={[styles.sliderText, styles.HWtAHFrT]}>$80k</Text>
        </View>
        ...
        <View style={styles.walletCard}>
          <View style={styles.walletInner}>
            <View style={[styles.imgContainer, styles.nqXHlFOA]}>
        ...
        <View style={styles.walletCard}>
          <View style={styles.walletInner}>
            <View style={[styles.imgContainer, styles.GXElSaQy]}>
              <Image source={require("./assets/edit.png")} style={styles.image} />
            </View>
